      ...
      <div class='flip-box'>
        ...
        <div class='flip-box-back text-center' style='background-image: linear-gradient(rgba(0, 0, 0, 0.200),rgba(0, 0, 0, 0.5)) , url({$img2});'>
          <div class='inner color-white'>
            <h3 class='flip-box-header'>{$rows['cat_name']}</h3>
            <p>{$rows['cat_desc']}</p>
            <a style='text-decoration: none' href='edit_cat.php?id={$rows['cat_id']}'><button class='flip-box-button'>Edit </button></a>
            <a style='text-decoration: none' href='delete_catergorys.php?id={$rows['cat_id']}'><button class='flip-box-button'>Delete </button></a>
          </div>
        </div>
      </div>
    </div>
